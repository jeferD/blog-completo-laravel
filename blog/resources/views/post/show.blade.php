<x-app-layout>
  <div class="flex">
    <div class="w-96 flex-auto relative overflow-hidden bg-white">
      <div class="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
        <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          <div class="sm:max-w-lg">
            <h1 class="font text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">{{$post->name}}</h1>
            <p class="mt-4 text-xl text-gray-500">{{$post->extract}}</p>
          </div>
          <div>
            <div class="mt-10">
                  ...
                  <div class="flex items-center space-x-6 lg:space-x-8">
                    <div class="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                      <div class="h-64 w-44 overflow-hidden rounded-lg sm:opacity-0 lg:opacity-100">
                        <img src="{{$post->image->url}}" alt="" class="h-full w-full object-cover object-center">
                      </div>
    ...
    <aside class="">
      ...
      <ul>
        <h2 class="text-2xl font-bold text-gray-600 mb-4">Similares</h2>
        @foreach($similares as $similar)
          <a class="flex mt-4 mb-4" href="{{route('posts.show', $similar)}}">
            <li class=" h-64 w-44 rounded-lg">
              <h3 class="text-base font-bold text-gray-600 mb-4">{{$similar->name}}</h3>
              <img src="{{$similar->image->url}}" alt="" class="h-full w-full object-cover object-center">
